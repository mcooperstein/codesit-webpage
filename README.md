...
## Known Bugs/Issues
When viewing the website on a mobile device, the contact phone number above the form doesn't display. However, if you click on the blank space where the phone number is, the number will display and give the user the option to call that number. I tried a few different things to fix this issue, but couldn't figure it out.
